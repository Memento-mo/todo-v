<template>
  <form @submit.prevent="submitLogin" class="auth-form">
    ...
    <input
      ...
      :class="{ error: isError }"
    />
    <p class="error-message" v-show="isError">Логин и пароль не совпадают.</p>
    <div class="buttons">
      <router-link to="/auth/signup" type="submit" class="link create-user">Создать аккаунт</router-link>
